...
<h3>Windows</h3>
paste `powershell -ExecutionPolicy Bypass -c "irm https://github.com/PurpleCraft999/rsdex/releases/download/v0.1.0/rsdex-installer.ps1 | iex" `
into the Command Promt and it will install it automaticly

<h3>Linux</h3>

paste `curl --proto '=https' --tlsv1.2 -LsSf https://github.com/PurpleCraft999/rsdex/releases/download/v0.1.0/rsdex-installer.sh | sh`
